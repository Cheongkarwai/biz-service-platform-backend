...
@Component
public class InactiveAccountState implements AccountState{

    private final AccountRepository accountRepository;

    private final AccountMapper accountMapper;

    public InactiveAccountState(AccountRepository accountRepository,
    ...
    public Mono<AccountDTO> deactivate(AccountDTO accountDTO) {
        return Mono.error(new AccountStateInvalidException("Account is already inactive"));
    }
